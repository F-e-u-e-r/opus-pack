...
| 21 | SUSPECT [M] | owner adjudicates: restore | — | marker re-enters the outcome domain, NOT terminal: its suspended unrun original slots resume (queued per RUNBOOK §2's deterministic resume mechanics), and §D is computed at close over ALL its counted runs (preserved and post-resume alike) | adjudication receipt | none |
