...
## Round-2 context
Round 1: BOTH reviewers independently converged on ONE blocking finding (chronology): the rule-text marker dated the addition-side over-report 2026-08-28 while the provenance places results (11)–(12) under 2026-08-29, and the provenance opening over-broadly assigned all mechanics to 08-28. The maintainer reproduced it (a #225-internal inconsistency: the second source commit added results 11–12 without re-syncing the rule-text date clause) and authored **MOD-DATE**: the rule-text marker now reads "…materialization set, the merge-tree preview and the merge-base longhand were verified against fixtures 2026-08-28, the addition-side over-report and the complementary-read divergence against fixtures 2026-08-29…", and the provenance opens "results (1)–(10) on 2026-08-28, results (11)–(12) on 2026-08-29". The faithful-reconstruction claim is now: landed = #225 semantics + MOD-C2c + MOD-DATE, machine-verified, zero other drift. Re-review the same ten axes on the CURRENT full diff below; verify the date split is now consistent everywhere.
...
|---|---|---|---|---|
| 1 | `@@ -281,21 +281,69 @@` | 21,69 | 21,69 | EXACT |
| 2 | `@@ -308,9 +356,12 @@` | 9,12 | 9,12 | EXACT |
| 3 | `@@ -1424,11 +1475,65 @@` | 11,65 | 11,65 | EXACT |

## THE EXACT DIFF UNDER REVIEW
```diff
diff --git a/skills/operational-rigor/SKILL.md b/skills/operational-rigor/SKILL.md
index 63cd099..1e33beb 100644
--- a/skills/operational-rigor/SKILL.md
+++ b/skills/operational-rigor/SKILL.md
@@ -281,21 +281,69 @@ When rigor conflicts with finishing sooner, rigor wins.
...
@@ -308,9 +356,12 @@ When rigor conflicts with finishing sooner, rigor wins.
...
@@ -1424,11 +1475,65 @@ shipped after the branch's base. The incident's original reading — "a
...
+
+Both bullets' GIT MECHANICS were probed against throwaway fixtures
+(git 2.50.1) — results (1)–(10) on 2026-08-28, results (11)–(12) on
+2026-08-29 — after a two-family prose review of the same text
