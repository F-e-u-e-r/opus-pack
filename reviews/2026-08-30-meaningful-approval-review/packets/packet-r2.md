...
## 0. Changes since round 1 (an independent round-1 pass raised these; confirm resolved, review the whole afresh)
...
>   withholding decision-relevant risk so the operator approves without an informed
>   view of it, or hiding a consequential action inside a benign-looking approval
>   batch. The mere presence of multiple
...
>   surfaced scope. For a repeated request, the tell is persistence whose stopping
>   condition is approval rather than a new decision basis or delivery recovery.
